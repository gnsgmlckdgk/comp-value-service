...
import com.finance.dart.api.abroad.util.sec.AssetsCurrentExtractor;
import com.finance.dart.api.abroad.util.sec.OperatingIncomeExtractor;
import com.finance.dart.api.abroad.util.sec.SecUtil;
...
@AllArgsConstructor
@Service
public class US_StockCalFromSecService {
    ...
    private final SecFinStatementService secFinStatementService;                 // 해외기업 재무제표 조회 서비스
    ...
    private String[] getOperatingIncomeLoss(String cik, CompanySharePriceCalculator spc, CompanySharePriceResultDetail rstDetail) {
        ...
        List<OperatingIncomeExtractor.Result> incomeLoss = secFinStatementService.findFS_OperatingIncomeLoss(cik);
...
//        usdArr[2] = lastUsdB2;
    ...
    private String getAssetsCurrent(String cik, CompanySharePriceCalculator spc, CompanySharePriceResultDetail rstDetail) {
        ...
        CommonFinancialStatementDto assetsCurrent = secFinStatementService.findFS_AssetsCurrent(cik);

        if(assetsCurrent == null) {
            //@ 전체 제무정보 조회
            Map<String, Object> companyfacts = secFinStatementService.findFS_Companyfacts(cik);
    ...
    private String getLiabilitiesCurrent(String cik, CompanySharePriceCalculator spc, CompanySharePriceResultDetail rstDetail) {
        CommonFinancialStatementDto liabilitiesCurrent = secFinStatementService.findFS_LiabilitiesCurrent(cik);
...
//        String currentRatioPct = CalUtil.scale(CalUtil.multi(ratio, "100"), 2, RoundingMode.HALF_UP);
    ...
    private String getLiabilitiesNoncurrent(String cik, CompanySharePriceCalculator spc, CompanySharePriceResultDetail rstDetail) {
        CommonFinancialStatementDto liabilitiesNoncurrent = secFinStatementService.findFS_LiabilitiesNoncurrent(cik);
    ...
    private String getEntityCommonStockSharesOutstanding(String cik, CompanySharePriceCalculator spc, CompanySharePriceResultDetail rstDetail) {
        ...
        String result = secFinStatementService.getStockSharesOutstanding(cik);
